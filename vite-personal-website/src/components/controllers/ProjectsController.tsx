...
const projects: any[] = [
    {
        name: "Lego Bin Organizer",
        tags: ["Python3"],
        description: "Separate your massive lego bin into their original sets. Connect to a local server from your phone and fill out your JSON inventory by taking picture of lego pieces.",
        images: ["lego-bin.jpg", "lego-sorting.jpg"]
    },
    {
